...
We proceed to quantize our fields by promoting them to Hermitian operators that act on a Fock space. In terms of the usual Fourier mode expansion, our quantum operators, denoted with a hat superscript~$\hat{ }$~from now on, are given by
\begin{align}
	\label{vexp}
